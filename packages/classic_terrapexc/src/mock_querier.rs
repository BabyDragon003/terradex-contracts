...
pub struct WasmMockQuerier {
    ...
    terrapexc_factory_querier: TerrapexcFactoryQuerier,
}
...
impl WasmMockQuerier {
    pub fn new(base: MockQuerier<TerraQueryWrapper>) -> Self {
        WasmMockQuerier {
            ...
            terrapexc_factory_querier: TerrapexcFactoryQuerier::default(),
        }
    }
    ...
    // configure the terrapexc pair
    pub fn with_terrapexc_factory(
        &mut self,
        pairs: &[(&String, &PairInfo)],
        native_token_decimals: &[(String, u8)],
    ) {
        self.terrapexc_factory_querier = TerrapexcFactoryQuerier::new(pairs, native_token_decimals);
    }
